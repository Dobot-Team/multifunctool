...
#define DobotV3Format_PAYLOAD_LENGTH 1024
...
ProtocolFrame_FORMAT_EXTERN(DobotV3Format) extern uint16_t DobotV3Format_PacketEncoder(PDobotV3Format_Packet pParm, uint16_t pDataLen);
